...
public class Estoque extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        btnVoltarProdutos.setText("Produtos");
        ...
        btnVoltar.setText("Menu Principal");
    ...
    private void btnVoltarProdutosActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnVoltarProdutosActionPerformed
        Produtos produto = new Produtos(); //instancia tela inicial como objeto para uso
        produto.setVisible(true); // Isso quer dizer que a Produtos é chamada para ficar visivel novamente
        this.dispose(); //fecha Estoque
